...
const inputDir = path.join(rootDir, "assets/src/images/source");
const outputWebp = path.join(rootDir, "assets/src/images/WEBP");
const outputAvif = path.join(rootDir, "assets/src/images/AVIF");
