...
const sourceDir = path.join(rootDir, "assets/src/favicons/source");
const outputDir = path.join(rootDir, "assets/src/favicons");
...
if (!files.length) {
  console.log("Нет исходников в assets/src/favicons/source");
  process.exit();
}
...
const siteName = process.env.SITE_NAME || "My WordPress Site";
const shortName = process.env.SITE_SHORT_NAME || "WP Site";
...
const manifest = {
  ...
  icons: [
    {
      src: "/assets/src/favicons/android-chrome-192x192.png",
      sizes: "192x192",
      type: "image/png"
    },
    {
      src: "/assets/src/favicons/android-chrome-512x512.png",
      sizes: "512x512",
      type: "image/png"
    }
  ],
...
console.log("\nFavicons и PWA icons готовы! Все файлы в assets/src/favicons");
...
<link rel="icon" type="image/png" sizes="32x32" href="<?php echo get_template_directory_uri(); ?>/assets/src/favicons/favicon-32x32.png">
<link rel="icon" type="image/png" sizes="16x16" href="<?php echo get_template_directory_uri(); ?>/assets/src/favicons/favicon-16x16.png">
<link rel="manifest" href="<?php echo get_template_directory_uri(); ?>/assets/src/favicons/site.webmanifest">
<link rel="mask-icon" href="<?php echo get_template_directory_uri(); ?>/assets/src/favicons/safari-pinned-tab.svg" color="#5bbad5">
